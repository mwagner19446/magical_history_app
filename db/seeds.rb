...
upper_east_side = Neighborhood.create(name: "Upper East Side", latitude: 40.7692, longitude: -73.9656, description: "The Upper East Side is a neighborhood in the borough of Manhattan in New York City, between Central Park and the East River. The Upper East Side lies within an area bounded by 59th Street to 96th Street, and the East River to Fifth Avenue-Central Park.")
